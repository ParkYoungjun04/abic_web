...
const Scan_qna_viewer_client = () => {
  ...
  const getValue = (title, value) => {
    ...
    let tempChecked = content1.map((item) =>
      item.title === title ? { ...item, checked: value } : item
    );
  ...
  useEffect(() => {
    Axios.get("http://34.68.101.191:8000/get/Scan_qna_client", {
      ...
      if (data.DT_1_NAME) {
        setCont3checkName([...cont3checkName, data.DT_1_NAME]);
      }
      if (data.DT_2_NAME) {
        setCont3checkName([...cont3checkName, data.DT_2_NAME, data.DT_2_NAME]);
      }
    });
    Axios.get("http://34.68.101.191:8000/get/Scan_state", {
      params: { business_name: business_name, key: "client" },
    }).then((response) => {
      setClientState(response.data[0].STATE_ID);
    });
  }, []);
  //모달 외부 클릭 시 닫힘
                    ...
                    <td className="Scan_qna_client_table_title_checkbox">
                      <input
                        ...
                        checked={
                          item.checked === "0"
                            ? false
                            : item.checked === item.id1
                            ? true
                            : false
                        }
                        disabled={clientState.slice(-2) === "C2" ? true : false}
                      />
                ...
                <tr>
                  ...
                  <td rowSpan="2">
                    <input
                      ...
                      checked={clientData.MK_1 === 1 ? true : false}
                      disabled={clientState.slice(-2) === "C2" ? true : false}
                    />
                    <label htmlFor="2-1" />
                    <label htmlFor="2-1">
                  ...
                  <td rowSpan="2">
                    <input
                      ...
                      checked={clientData.MK_2 === 1 ? true : false}
                      disabled={clientState.slice(-2) === "C2" ? true : false}
                    />
                    <label htmlFor="2-2" />
                    <label htmlFor="2-2">
                ...
                <tr>
                  ...
                  <td rowSpan="2">
                    <input
                      ...
                      checked={clientData.MK_3 === 1 ? true : false}
                      disabled={clientState.slice(-2) === "C2" ? true : false}
                    />
                    <label htmlFor="2-3" />
                    <label htmlFor="2-3">
                  ...
                  <td rowSpan="2">
                    <input
                      ...
                      checked={clientData.MK_4 === 1 ? true : false}
                      disabled={clientState.slice(-2) === "C2" ? true : false}
                    />
                    <label htmlFor="2-4" />
                    <label htmlFor="2-4">
                ...
                <div key={index} className="Scan_qna_client_content_box_cont1">
                    ...
                    <div className="Scan_qna_client_content_box_cont1_title2">
                      ...
                      <div className="Scan_qna_client_content_box_cont1_title2_input">
                        <input
                          ...
                          checked={
                            clientData[`DT_${index + 1}_1`] === 1 ? true : false
                          }
                          disabled={
                            clientState.slice(-2) === "C2" ? true : false
                          }
                        />
                      ...
                      <div className="Scan_qna_client_content_box_cont1_title2_input">
                        <input
                          ...
                          checked={
                            clientData[`DT_${index + 1}_2`] === 1 ? true : false
                          }
                          disabled={
                            clientState.slice(-2) === "C2" ? true : false
                          }
                    ...
                    <div className="Scan_qna_client_content_box_cont1_title3">
                      ...
                      <div className="Scan_qna_client_content_box_cont1_title3_input">
                        <input
                          ...
                          checked={
                            clientData[`DT_${index + 1}_3`] === 1 ? true : false
                          }
                          disabled={
                            clientState.slice(-2) === "C2" ? true : false
                          }
                      ...
                      <div className="Scan_qna_client_content_box_cont1_title3_input">
                        <input
                          ...
                          checked={
                            clientData[`DT_${index + 1}_4`] === 1 ? true : false
                          }
                          disabled={
                            clientState.slice(-2) === "C2" ? true : false
                          }
                      ...
                      <div className="Scan_qna_client_content_box_cont1_title3_input">
                        <input
                          ...
                          checked={
                            clientData[`DT_${index + 1}_5`] === 1 ? true : false
                          }
                          disabled={
                            clientState.slice(-2) === "C2" ? true : false
                          }
                  ...
                  <div className="Scan_qna_client_content_box_cont1_text_box">
                    <textarea
                      ...
                      placeholder="추가 설명"
                      value={clientData[`DT_${index + 1}_TEXT`]}
                      onChange={(e) => {
...
export default Scan_qna_viewer_client;
