  ...
  useEffect(() => {
    Axios.get("http://34.68.101.191:8000/get/Focus_qna_client", {
      ...
      setFiles({
        ...
        file2_6: data["F_2_6"] ? { name: data["F_2_6"] } : "",
        file2_7: data["F_2_7"] ? { name: data["F_2_7"] } : "",
        file2_8: data["F_2_8"] ? { name: data["F_2_8"] } : "",

        file3_1: data["F_3_1"] ? { name: data["F_3_1"] } : "",
        file3_2: data["F_3_2"] ? { name: data["F_3_2"] } : "",
        file3_3: data["F_3_3"] ? { name: data["F_3_3"] } : "",
        file3_4: data["F_3_4"] ? { name: data["F_3_4"] } : "",
...
export default Focus_qna_b_viewer_client;
